...
describeIfSystemDic('TokenChunkerPlugin system.dic validation', () => {
	...
	test('merges added grammar chunks with real dictionary tokenization', () => {
		const cases: Array<{
			...
			{
				text: 'だだ．．．だいじょうぶ大丈夫です別に罰則とかありませんから．．．',
				without: [
					'だだ',
					'…',
					'だいじょうぶ',
			...
			{
				text: 'さっきあの人ねことね',
				without: ['さっき', 'あの', '人', 'ねこ', 'と', 'ね'],
				with: ['さっき', 'あの', '人', 'ねこ', 'と', 'ね'],
			},
			{
				text: '普通にやだ．．．',
				without: ['普通', 'に', 'や', 'だ', '.', '.', '.'],
			...
			{
				text: 'こないだのお詫びとこれからよろしくという意味を込めまして',
				without: [
					'こないだ',
					'の',
					'お',
			...
			},
			{
				...
				with: ['いやいや', '別に', 'いいよ', 'そんな', '気', 'を', '遣わなくて'],
			},
			{
				text: 'いえ．．．させてもらいます！',
				without: ['いえ', '.', '.', '.', 'さ', 'せ', 'て', 'もらい', 'ます', '!'],
				with: ['いえ', '.', '.', '.', 'させて', 'もらい', 'ます', '!'],
			},
			{
				text: 'あるわけないじゃん汚いっ！',
