This project is a TypeScript port of [Sudachi](https://github.com/WorksApplications/Sudachi) Japanese morphological analyzer.

- After making changes ensure that there are not typescript errors, no lint errors or warnings and all tests pass.
